...
run_one() {
  ...
  local mpl_dir="/tmp/mpl_resume_gpu2_${tag}"
...
run_one E15 PFLALP 1 1000 --purify_beta 1500 --purify_rounds 1 --cluster_max_k 4
run_one E19 FedRepPFLALP 1 1000 --alp_use_cluster 1 --alp_use_purify 0 --cluster_max_k 6
