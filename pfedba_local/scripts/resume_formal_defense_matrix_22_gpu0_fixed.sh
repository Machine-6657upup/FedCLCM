...
run_one() {
  ...
  local mpl_dir="/tmp/mpl_resume_gpu0_${tag}"
...
run_one E13 FedRepPFLALP 1 1000 --alp_use_cluster 1 --alp_use_purify 0 --cluster_max_k 4
run_one E17 FedRT 1 1000 --rt_beta 0.10 --adv_eps 0.10 --adv_num_iter 5 --aug_strength 0.10
run_one E21 PFLALP 1 1000 --purify_beta 1500 --purify_rounds 2 --cluster_max_k 4
