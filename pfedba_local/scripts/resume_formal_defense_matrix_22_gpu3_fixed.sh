...
run_one() {
  ...
  local mpl_dir="/tmp/mpl_resume_gpu3_${tag}"
...
run_one E04 PFLALP 10 400 --purify_beta 1500 --purify_rounds 1 --cluster_max_k 4
run_one E08 FedRepPFLALP 10 400 --alp_use_cluster 1 --alp_use_purify 0 --cluster_max_k 6
