...
# Set by the dataset-generation wrapper before the generator runs.
# This prevents stale cache reuse when backdoor-related settings differ.
...
def check(config_path, train_path, test_path, num_clients, niid=False, 
    ...
    if os.path.exists(config_path):
        ...
        if config['num_clients'] == num_clients and \
            ...
            config.get('train_ratio') == train_ratio and \
            config.get('generation_fingerprint', {}) == generation_fingerprint:
