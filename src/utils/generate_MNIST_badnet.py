...
def generate_dataset(dir_path, num_clients, niid, balance, partition, backdoor_rate, target_y):
    ...
    for i in range(adversary_num):
        train_data[i] = add_trigger28_badnet(train_data[i], backdoor_rate, target_y)
...
if __name__ == "__main__":
    ...
    backdoor_rate = 0.5
    adversary_num = 5
    dir_path = f"../MNIST_dir0.5_bdoor{backdoor_rate}_nclient_{num_clients}_badnet_adv{adversary_num}/"
    target_y = 0
